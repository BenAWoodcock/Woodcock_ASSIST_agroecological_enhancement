...
#Treat  1.6267  0.8133     2 14.0000  4.4801 0.03134 *
#Crop  14.1110  7.0555     2  2.2675 38.8645 0.01760 *
...
#(Intercept)   2.7270     1.0995  3.2000   2.480  0.08397 . 
#TreatT2       0.3122     0.2130 14.0000   1.466  0.16488   
#TreatT3       0.6377     0.2130 14.0000   2.993  0.00968 **
#  CropWB        4.3960     0.5194  2.1022   8.464  0.01174 * 
#  CropWW        4.5660     1.4051  3.0738   3.250  0.04589 *
  
  emmeans(Prec_yield_treat_response_m2, ~ Treat)
# Treat emmean    SE  df lower.CL upper.CL
#T1      5.71 0.796 3.2     3.27     8.16
#T2      6.03 0.796 3.2     3.58     8.47
#T3      6.35 0.796 3.2     3.91     8.80
...
#                Sum Sq Mean Sq NumDF  DenDF F value    Pr(>F)    
#Treat          0.12674 0.06337     2 94.797  5.3073  0.006535 ** 
#Year_since_est 0.17688 0.05896     3 30.849  4.9379  0.006467 ** 
#Crop           1.76288 0.29381     6 37.492 24.6070 1.333e-11 ***

simulationOutput<-simulateResiduals(fittedModel=yield, plot=F)
plot(simulationOutput) # model meets assumptions
summary(yield)
emmeans(yield, ~ Treat*Crop)
#
